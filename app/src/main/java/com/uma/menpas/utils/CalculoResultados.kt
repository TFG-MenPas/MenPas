...
class CalculoResultados {
    ...
    private fun calculateCSAI2(respuestasUsuario: ArrayList<String>): Map<String, String> {
        val keys = listOf("Nombre_Usuario","Cognitiva", "Somatica", "Autoconfianza", "Fecha", "Item1","Item2","Item3","Item4",
        ...
        val listaFinal = nombreUsuario + finalValues + fecha + respuestasUsuarioFinal + ultimosValores
