...
class RegistroUsuario : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val generoArrayAdapter = ArrayAdapter.createFromResource(this,
        ...
        val deporteArrayAdapter = ArrayAdapter.createFromResource(this,
            R.array.deportes_array,
            R.layout.spinner_list
        )
        ...
        val nacionalidadArrayAdapter = ArrayAdapter.createFromResource(this,
        ...
        val estadoCivilArrayAdapter = ArrayAdapter.createFromResource(this,
        ...
        val nivelEstudiosArrayAdapter = ArrayAdapter.createFromResource(this,
            R.array.nivelEstudios_array,
            R.layout.spinner_list
        )
        ...
        val horasSemanaDeporteArrayAdapter = ArrayAdapter.createFromResource(this,
        ...
        val profesionArrayAdapter = ArrayAdapter.createFromResource(this,
