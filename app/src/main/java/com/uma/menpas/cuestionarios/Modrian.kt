...
class Modrian {
    companion object {
        fun calculateFotos(respuestasUsuario: ArrayList<String>,  nombreUsuario: String): Map<String, String> {
            val keys = listOf(
                "ID_Modrian",
                "Nombre_Usuario",
                "Numero_Aciertos",
        ...
        fun calculateStroop(respuestasUsuario: ArrayList<String>,  nombreUsuario: String): Map<String, String> {
            val keys = listOf(
                "ID_Modrian",
                "Nombre_Usuario",
                "Numero_Aciertos",
            ...
            val tiempo_realizacion = respuestasUsuario[8]
            val fecha = ParseUtils.formattedString(ParseUtils.obtenerFechaActual())
            val tipo = ParseUtils.formattedString("Modrian Stroop")
            val sonido = ParseUtils.formattedString("True")
            val idioma = ParseUtils.formattedString("es-es")
            val version = ParseUtils.formattedString("Android")
            val values = listOf(
